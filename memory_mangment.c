...
/**
 **_realloc -  Reallocates A Memory Block Using Malloc And Free Usnig Pointers
 *@ptr: Pointer
...
/**
 * free_all - Free Array Of Char Pointer And Char Pointer Array Pointer Char Pointer
 * @cmd:Array Pointer
 * @line:Char Pointer
 * Return: Void
 */
